defmodule Kerosene.PaginatorModesTest do
  ...
  test "uses mode from config" do
    Application.put_env(:kerosene, :mode, :simple)
    current_page = 5
  ...
  defp list_for_page(page_num, opts) do
    ...
    paginator = %Kerosene{items: [], per_page: 10, page: page_num, total_pages: 5, total_count: 0, params: %{}}
